...
export default function ContactHero() {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us - Manpower Network</title>
        <meta
          name="description"
          content="Get in touch with Manpower Network. Choose a city to connect with your local team of experts."
        />
        <meta property="og:title" content="Contact Us - Manpower Network" />
        <meta
        ...
        <meta property="og:url" content="https://manpowernet.work/contact" />
